...
class CarController:
  ...
  def update(self, CC, CS):
    ...
    if self.CP.carFingerprint in CANFD_CAR:
      ...
      if self.frame % 2 == 0 and self.CP.mdpsBus==1:
        enabled_speed = 60
      ...
      if self.CP.carFingerprint in (CAR.GENESIS_G90_2019, CAR.GENESIS_G90, CAR.K7) or self.CP.mdpsBus==1:
